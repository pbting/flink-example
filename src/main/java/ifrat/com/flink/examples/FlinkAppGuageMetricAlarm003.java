...
public class FlinkAppGuageMetricAlarm003 {
...
//        environment.setStreamTimeCharacteristic(TimeCharacteristic.EventTime);
        environment.getConfig().setAutoWatermarkInterval(TimeUnit.SECONDS.toMillis(2));
                ...
                .assignTimestampsAndWatermarks(
                        new AssignerWithPeriodicWatermarks<ImitateMetricData>() {
                            ...
                            public Watermark getCurrentWatermark() {
                                ...
                                System.err.println(new Date() + " => get current watermark .");
